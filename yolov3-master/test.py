...
def test(
    ...
    dataset = LoadImagesAndLabels(test_path, img_size, batch_size, augment=False, rect=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/best_1015_tiny.pt', help='path to weights file')
