...
运行脚本后，在终端显示9个 anchor box 的值，用来替代yolov3源码中 /cfg 目录下 .cfg
 后缀文件（如yolov3-voc.cfg）中的，基于 ImageNet 训练获得的的anchor box 尺寸
...
def main(argv):
    ...
    parser.add_argument('-filelist', default = r'data\trainlabels.txt',
                        help='path to filelist\n' )
    parser.add_argument('-output_dir', default = r'anchors', type = str,
