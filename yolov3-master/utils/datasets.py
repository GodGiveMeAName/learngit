...
class LoadWebcam:  # for inference
    ...
    def __next__(self):
        ...
        # img0 = cv2.flip(img0, 1)  # flip left-right             ---- Modefied by ZWX ----------
...
class LoadImagesAndLabels_VOC(Dataset):  # for training/testing
...
def letterbox(img, new_shape=416, color=(255.0, 255.0, 255.0), mode='square'):
